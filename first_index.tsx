...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Ravi weds Ranjana ΓÇö A Royal Indian Wedding" },
    ...
    <Section id="home" accent="oklch(0.34 0.13 18)" className="min-h-screen flex items-center justify-center">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-6 max-w-2xl font-deva text-lg leading-relaxed text-gold-gradient md:text-2xl">
          αñ╡αñòαÑìαñ░αññαÑüαñúαÑìαñí αñ«αñ╣αñ╛αñòαñ╛αñ» αñ╕αÑéαñ░αÑìαñ»αñòαÑïαñƒαñ┐ αñ╕αñ«αñ¬αÑìαñ░αñ¡ αÑñ<br />
          αñ¿αñ┐αñ░αÑìαñ╡αñ┐αñÿαÑìαñ¿αñé αñòαÑüαñ░αÑü αñ«αÑç αñªαÑçαñ╡ αñ╕αñ░αÑìαñ╡αñòαñ╛αñ░αÑìαñ»αÑçαñ╖αÑü αñ╕αñ░αÑìαñ╡αñªαñ╛ αÑÑ
        </p>
        <p className="mt-8 font-display text-xs tracking-[0.5em] text-ivory/70">WITH THE BLESSINGS OF FAMILIES</p>

        {/* Couple Name ΓÇö Moved below blessings */}
        <motion.div
      ...
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl font-serif italic text-ivory/80">
            Five sacred celebrations ΓÇö each a chapter of love, tradition &amp; joy.
          </p>
          <p className="mt-2 font-display text-[10px] tracking-[0.5em] text-pink-300/60 uppercase">
            Γÿà Scratch each card to reveal the ceremony Γÿà
          </p>
        </div>

        {/* Uniform 5-card grid ΓÇö all same fixed height */}
...
const rituals = [
  { 
    ...
    description: "The auspicious haldi paste ΓÇö turmeric, sandalwood, rosewater ΓÇö applied by loved ones to bless the bride and groom with a glowing radiance.", 
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-6 rounded-2xl border border-gold/40 bg-black/40 p-8 backdrop-blur-md">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 md:flex-row md:justify-center">
            ...
            >
              {showMap ? "HIDE MAP Γåæ" : "VIEW LOCATION ON MAP Γåô"}
            </button>
      ...
      <AnimatePresence>
        {accepted && (
          ...
          >
            ...
            >
              <motion.div animate={{ rotate: [0,-12,12,-6,6,0] }} transition={{ delay: 0.5, duration: 0.9 }} className="text-7xl">≡ƒÄè</motion.div>
              ...
              <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:0.85 }}>
                <p className="mt-6 font-serif text-lg leading-relaxed text-ivory/95">
                  Ravi &amp; Ranjana are overjoyed to celebrate this special day with you. We can't wait! ≡ƒî╕
                </p>
      ...
      <Section id="accept" accent="oklch(0.30 0.13 18)">
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            ...
            >
              <span>≡ƒÄë</span> ACCEPT INVITATION <span>≡ƒÄë</span>
            </motion.button>
          </motion.div>
        </div>
      </Section>
